...
public class AddEmployeeServlet extends HttpServlet {
	...
	req.setAttribute("employeeId",resemployeeId);
	req.setAttribute("employeePassword",resemployeePassword);
	req.setAttribute("employeeName",resemployeeName);
	req.setAttribute("employeeNumber",resemployeeNumber);
	req.setAttribute("gender",resgender);	
	req.setAttribute("employeeEmail",resemployeeEmail);
	req.setAttribute("employeeAddress",resemployeeAddress);
	...
	String res=csobj.addEmployee(registerobj);
